...
public final class GraphHopperGtfs {
    ...
    public static class Factory {
        ...
        public GraphHopperGtfs createWith(GtfsRealtime.FeedMessage realtimeFeed, String agencyId) {
            return new GraphHopperGtfs(flagEncoder, translationMap, graphHopperStorage, locationIndex, gtfsStorage, RealtimeFeed.fromProtobuf(graphHopperStorage, gtfsStorage, flagEncoder, realtimeFeed, agencyId));
        }
    ...
    private class RequestHandler {
        ...
        private void substitutePointWithVirtualNode(int index, boolean reverse, GHPoint ghPoint, ArrayList<QueryResult> allQueryResults) {
            ...
            for (Label stationNode : stationNodes) {
                ...
                final long time = Math.min(pathWrapper.getTime() / 1000, 1); // Must be non-0 because it's also a marker for being a virtual edge
