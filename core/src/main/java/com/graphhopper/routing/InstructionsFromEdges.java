...
public class InstructionsFromEdges implements Path.EdgeVisitor {
    ...
    public InstructionsFromEdges(Graph graph, Weighting weighting,
        ...
        prevName = null;
        outEdgeExplorer = graph.createEdgeExplorer(DefaultEdgeFilter.outEdges(this.accessEnc));
        crossingExplorer = graph.createEdgeExplorer(DefaultEdgeFilter.allEdges(this.accessEnc));
    }
